...
contract FundMeTest is Test {
    ...
    function testPriceFeedGetVersion() public {
    ...
    function testOnlyCanOwnerWithdraw() public funded {
        vm.prank(USER);
    ...
    // function testCheckPlease() public funded {
    //     vm.prank(USER);
    //     //vm.expectRevert();
    //     address(fundMe).call{value: SEND_VALUE}("This is a fallback");
